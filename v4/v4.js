...
function a1() {
    ...
    if (document.getElementById("a1").innerHTML=== "") {
        ...
        if (turno.get() === 0) {
            ...
            document.getElementById("a1").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(1);
            checar(x);

        } else if (turno.get() === 1) {
            document.getElementById("a1").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(1);
            checar(o);
        }
...
function a2() {
    ...
    if (document.getElementById("a2").innerHTML === "") {
        ...
        if (turno.get() === 0) {
            document.getElementById("a2").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(2);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("a2").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(2);
            checar(o);
        }
...
function a3() {
    ...
    if (document.getElementById("a3").innerHTML=== "") {
        ...
        if (turno.get() === 0) {
            document.getElementById("a3").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(3);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("a3").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(3);
            checar(o);
        }
...
function b1() {
    if (document.getElementById("b1").innerHTML=== "") {
        if (turno.get() === 0) {
            document.getElementById("b1").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(4);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("b1").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(4);
            checar(o);
        }
...
function b2() {
    if (document.getElementById("b2").innerHTML=== "") {
        if (turno.get() === 0) {
            document.getElementById("b2").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(5);
        } else if (turno.get() === 1) {
            checar(x);
            document.getElementById("b2").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(5);
            checar(o);
        }
...
function b3() {
    if (document.getElementById("b3").innerHTML=== "") {
        if (turno.get() === 0) {
            document.getElementById("b3").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(6);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("b3").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(6);
            checar(o);
        }
...
function c1() {
    if (document.getElementById("c1").innerHTML=== "") {
        if (turno.get() === 0) {
            document.getElementById("c1").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(7);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("c1").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(7);
            checar(o);
        }
...
function c2() {
    if (document.getElementById("c2").innerHTML=== "") {
        if (turno.get() === 0) {
            document.getElementById("c2").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(8);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("c2").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(8);
            checar(o);
        }
...
function c3() {
    if (document.getElementById("c3").innerHTML=== "") {
        if (turno.get() === 0) {
            document.getElementById("c3").innerHTML = ' <img src="x.png" alt=""> ';
            turno.set(1);
            x.push(9);
            checar(x);
        } else if (turno.get() === 1) {
            document.getElementById("c3").innerHTML = '<img src="o.png" alt="">';
            turno.set(0);
            o.push(9);
            checar(o);
        }
